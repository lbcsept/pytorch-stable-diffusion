...
class UNET_ResidualBlock(nn.Module):
    def __init__(
        self, in_channels: int, out_channels: int, n_time: int = 4 * 320, groupnorm=32
    ):
        super().__init__()
...
class UNET_AttentionBlock(nn.Module):
    def __init__(
        self, n_head: int, n_embd: int, d_context: int = 768, groupnorm: int = 32
    ):
        super().__init__()
...
class UNET(nn.Module):
    def __init__(
        self, u_dim: int = 320, in_channels: int = 4, n_head: int = 8, n_emdb=40
    ):
        super().__init__()
        ...
        self.encoders = nn.ModuleList(
            [
                ...
                SwitchSequential(
                    nn.Conv2d(in_channels, u_dim, kernel_size=3, padding=1)
                ),
                SwitchSequential(
                    UNET_ResidualBlock(u_dim, u_dim),
                ...
                SwitchSequential(
                    nn.Conv2d(u_dim, u_dim, kernel_size=3, stride=2, padding=1)
                ),
                SwitchSequential(
                    UNET_ResidualBlock(u_dim, 2 * u_dim),
                    UNET_AttentionBlock(n_head, 2 * n_emdb),
                ),
                SwitchSequential(
                    UNET_ResidualBlock(2 * u_dim, 2 * u_dim),
                    UNET_AttentionBlock(n_head, 2 * n_emdb),
                ),
                # (batch_size, 2 * u_dim, h/16, w/16) -> (batch_size, 2 * u_dim, h/32, w/32)
                SwitchSequential(
                    nn.Conv2d(2 * u_dim, 2 * u_dim, kernel_size=3, stride=2, padding=1)
                ),
                SwitchSequential(
                    UNET_ResidualBlock(2 * u_dim, 4 * u_dim),
                ...
                SwitchSequential(
                    nn.Conv2d(4 * u_dim, 4 * u_dim, kernel_size=3, stride=2, padding=1)
                ),
        ...
        self.decoders = nn.ModuleList(
            [
                ...
                #     SwitchSequential(UNET_ResidualBlock(8 * u_dim, 4 * u_dim)),
                #     SwitchSequential(
                #         UNET_ResidualBlock(8 * u_dim, 4 * u_dim), Upsample(4 * u_dim)
                #     ),
                #     SwitchSequential(
                #         UNET_ResidualBlock(8 * u_dim, 4 * u_dim),
                #         UNET_AttentionBlock(n_head, 4 * n_emdb),
                #     ),
                #     SwitchSequential(
                #         UNET_ResidualBlock(8 * u_dim, 4 * u_dim),
                ...
                #     ),
                #     SwitchSequential(
                #         UNET_ResidualBlock(6 * u_dim, 4 * u_dim),
                #         UNET_AttentionBlock(n_head, 4 * n_emdb),
                #         Upsample(4 * u_dim),
                #     ),
                #     SwitchSequential(
                #         UNET_ResidualBlock(6 * u_dim, 2 * u_dim),
                #         UNET_AttentionBlock(n_head, 2 * n_emdb),
                #     ),
                #     SwitchSequential(
                #         UNET_ResidualBlock(4 * u_dim, 2 * u_dim),
                #         UNET_AttentionBlock(n_head, 2 * n_emdb),
                #     ),
                #     SwitchSequential(
                #         UNET_ResidualBlock(3 * u_dim, 2 * u_dim),
                #         UNET_AttentionBlock(n_head, 2 * n_emdb),
                #         Upsample(2 * u_dim),
                #     ),
                #     SwitchSequential(
                #         UNET_ResidualBlock(3 * u_dim, u_dim),
                #         UNET_AttentionBlock(n_head, n_emdb),
                #     ),
                #     SwitchSequential(
                #         UNET_ResidualBlock(2 * u_dim, u_dim),
                #         UNET_AttentionBlock(n_head, 2 * n_emdb),
                #     ),
                #     SwitchSequential(
                #         UNET_ResidualBlock(2 * u_dim, u_dim),
...
class UNET_OutputLayer(nn.Module):
    def __init__(
        self, in_channels: int, out_channels: int, groupnorm=32, time_dim: int = 320
    ):
        super().__init__()
